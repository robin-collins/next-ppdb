...
source: 'https://nextjs.org/docs/messages/middleware-to-proxy#why-this-error-occurred'
author:
  - '[[Josh Story]]'
  - '[[Sebastian Markbåge]]'
published:
...
[Docs](https://nextjs.org/docs) [Errors](https://nextjs.org/docs) Renaming Middleware to Proxy
